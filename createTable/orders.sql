...
ALTER TABLE ods_orders
    ADD IF NOT EXISTS PARTITION (dt = '20210325') location '/user/hive/warehouse/ods.db/ods_orders/dt=20210325/';
...
ALTER TABLE ods.ods_orders_receive
    ADD IF NOT EXISTS PARTITION (dt = '20210325') location '/user/hive/warehouse/ods.db/ods_orders_receive/dt=20210325/';
...
(
    ...
    tblproperties ("orc.compression" = "snappy");
ALTER TABLE ods.ods_refund_details
    ADD IF NOT EXISTS PARTITION (dt = '20210325') location '/user/hive/warehouse/ods.db/ods_refund_details/dt=20210325/';
--订单退货表
...
ALTER TABLE ods.ods_refund_apply
    ADD IF NOT EXISTS PARTITION (dt = '20210325') location '/user/hive/warehouse/ods.db/ods_refund_apply/dt=20210325/';